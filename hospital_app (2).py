...
DEPT_INFO = {
    ...
    'Neurology': {
        ...
        'desc':'Specialzizes in brain, spine, and nervous system conditions. ',
    ...
    'Dermatology': {
        ...
        'desc':'Specializes in skin, hair, and nail conditions. ',
        'next':['Visit Level 2, Wing D','Estimated wait: 10-20 min','Bring photos of affected area if possible']
    },
}
...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#8ccce7;border:1px solid #4e48a5;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#2c80b4;color:white;border-radius:8px;
    ...
    st.markdown("""
    <!-- COLOR3 -->
    <div style="background:#8ed3c0;border:1px solid #436157;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:hsl(156, 19%, 35%);color:rgb(255, 255, 255);border-radius:8px;
    ...
    st.markdown("""
    <!-- COLOR5 -->
    <div style="background:#9295d0;border:1px solid #1d1e3d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#344074;color:white;border-radius:8px;
    ...
    st.markdown("""
    <!-- COLOR6 -->
    <div style="background:#ffffff;border:1px solid #1c1643;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#2c276c;color:rgb(255, 255, 255);border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">5</span>
            <span style="font-size:16px;font-weight:600;color:#000040;">Patient Information</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with prob_col:
        ...
        st.markdown(bars_html + """
            ...
            <div style="margin-top:20px;background:#e90ee9;border:1px solid #ff0505;
                ...
                <strong>Model:</strong>KNN - 102.000 patient  - 99.5% accuracy<br>
